...
/* We don't use this function so commenting it out to suppress a warning.
 * NB. If we end up adding sub-functions this needs to be uncommented.
 * The forward declaration also needs to be uncommented.
